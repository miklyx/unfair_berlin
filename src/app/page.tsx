...
import type { BerlinMapProps } from "./components/BerlinMap";
...
const BerlinMap = dynamic<BerlinMapProps>(() => import("./components/BerlinMap"), {
  ssr: false,
...
export default function Home() {
  ...
  const [flyToPlaceId, setFlyToPlaceId] = useState<number | null>(null);
      ...
      <main className="app-shell unfair-page">
        <section className="map" aria-label="Map of unfair places">
          <BerlinMap
            ...
            flyToPlaceId={flyToPlaceId}
            onReportedPlaceClick={handleReportedPlaceClick}
            onOsmPlaceClick={handleOsmPlaceClick}
        ...
        <aside className="details-panel">
          ...
          <p className="map-hint">
            Use &quot;Pick on map&quot; in the form to choose coordinates, or click muted OSM places (cafes,
            restaurants, bars, pubs, nightclubs). Drag the map to pan, scroll to zoom.
          </p>
          ...
          <section className="panel-block collapsible-panel">
            ...
            >
              ...
              Submit a place
              <span className="sr-only">{isSubmissionFormOpen ? " (expanded)" : " (collapsed)"}</span>
            </button>
              ...
              {pendingSubmissions.map((submission) => (
                <li key={submission.id} className="moderation-item">
                  ...
                  <div className="moderation-actions">
                    ...
                    <button type="button" className="reject-btn" onClick={() => rejectSubmission(submission.id)}>
                      Reject
                    </button>
                  </div>
                </li>
